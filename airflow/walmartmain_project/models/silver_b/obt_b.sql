{% set configs =[
    ...
    {
        "table": "walmartmain.silver_t.orders_t",
        "columns":"""o.order_id,
                        o.store_id,
                        o.order_timestamp,
                        o.payment_method,
    ...
    {
        "table": "walmartmain.silver_t.customers_t",
    ...
    {
        "table": "walmartmain.silver_t.order_items_t",
    ...
    {
        "table": "walmartmain.silver_t.products_t",
    ...
    {
        "table": "walmartmain.silver_t.employees_t",
    ...
    {
        "table": "walmartmain.silver_t.stores_t",
